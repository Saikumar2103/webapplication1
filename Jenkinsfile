    ...
    stages {
        ...
        stage('Docker Tag the Image') {
            steps {
                ...
                sh 'sudo docker tag snapchat-sak-cicd-docker saikumar004/snapchat-sak-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Docker Push the Image') {
            steps {
                ...
                sh 'sudo docker push saikumar004/snapchat-sak-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Cleanup Local Docker Images') {
            steps {
                ...
                sh '''
                    sudo docker rmi saikumar004/snapchat-sak-cicd-docker:latest
